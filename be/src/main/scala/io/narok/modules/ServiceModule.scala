...
import io.narok.services.authentication.{GoogleService, GoogleServiceImpl, GoogleVerifier, GoogleVerifierImpl}
...
class ServiceModule(implicit executionContext: ExecutionContext) extends AbstractModule with ScalaModule {
  override def configure(): Unit = {
    ...
    bind[GoogleVerifier].to[GoogleVerifierImpl].in[com.google.inject.Singleton]
